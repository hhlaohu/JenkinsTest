...
/** 基本信息表**/
public class TabUsrinf extends BaseBean {
	...
	public String toString() {
		return "TabUsrinf [first_veriy_auth=" + first_veriy_auth + ", second_veriy_auth=" + second_veriy_auth
				+ ", final_veriy_auth=" + final_veriy_auth + ", credit_info_veriy_auth=" + credit_info_veriy_auth
				+ ", info_handle_auth=" + info_handle_auth + ", pic_type_mosaic=" + pic_type_mosaic + ", operator="
				+ operator + ", usrinf_id=" + usrinf_id + ", usrid=" + usrid + ", usrname=" + usrname + ", id_card="
				+ id_card + ", sex=" + sex + ", marital=" + marital + ", addr_province=" + addr_province
				+ ", addr_city=" + addr_city + ", addr_country=" + addr_country + ", addr_street=" + addr_street
				+ ", usr_native=" + usr_native + ", diploma=" + diploma + ", mobile_phone=" + mobile_phone
				+ ", home_phone=" + home_phone + ", profession=" + profession + ", profession_level=" + profession_level
				+ ", com_name=" + com_name + ", com_street=" + com_street + ", income=" + income + ", working_long="
				+ working_long + ", hiredate=" + hiredate + ", graduate_school=" + graduate_school + ", graduate_time="
				+ graduate_time + ", id_card_front_pic=" + id_card_front_pic + ", id_card_reverse_pic="
				+ id_card_reverse_pic + ", is_face_id_pass=" + is_face_id_pass + ", with_id_card_pic="
				+ with_id_card_pic + ", applyfo_flag=" + applyfo_flag + ", check_flag=" + check_flag + ", is_loan="
				+ is_loan + ", second_check_loan_limit=" + second_check_loan_limit + ", loan_limit=" + loan_limit
				+ ", loan_used=" + loan_used + ", is_firstquery=" + is_firstquery + ", applyfor_limit=" + applyfor_limit
				+ ", applyfor_time=" + applyfor_time + ", loan_useble=" + loan_useble + ", freeze_remark="
				+ freeze_remark + ", is_activate=" + is_activate + ", credit_report_pic=" + credit_report_pic
				+ ", limit_validity_time=" + limit_validity_time + ", credit_time=" + credit_time + ", credit_type="
				+ credit_type + ", first_check_operator=" + first_check_operator + ", second_check_operator="
				+ second_check_operator + ", check_alive_pic=" + check_alive_pic + ", xiaoshi_check_alive_result="
				+ xiaoshi_check_alive_result + ", xiaoshi_id_card_check_result=" + xiaoshi_id_card_check_result
				+ ", xiao_shi_left_times=" + xiao_shi_left_times + ", xiao_shi_invocation_time="
				+ xiao_shi_invocation_time + ", xiaoshi_id_card_check_msg=" + xiaoshi_id_card_check_msg
				+ ", xiaoshi_id_card_check_guid=" + xiaoshi_id_card_check_guid + ", xiaoshi_id_card_check_score="
				+ xiaoshi_id_card_check_score + "]";
	}
