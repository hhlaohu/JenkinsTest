...
/** 装修房产订单表**/
public class TabUsrDecorationOrder extends BaseBean {
	/**自动增长**/
	@Id
	...
	private List<TabUsrDecorationContractPic> pic_addr_tudcp_list;
	
	private List<TabUsrPremisePermitPic> pic_addr_tuppp_list;
	...
	public List<TabUsrDecorationContractPic> getPic_addr_tudcp_list() {
		return pic_addr_tudcp_list;
	}

	public void setPic_addr_tudcp_list(
			List<TabUsrDecorationContractPic> pic_addr_tudcp_list) {
		this.pic_addr_tudcp_list = pic_addr_tudcp_list;
	}

	public List<TabUsrPremisePermitPic> getPic_addr_tuppp_list() {
		return pic_addr_tuppp_list;
	}

	public void setPic_addr_tuppp_list(
			List<TabUsrPremisePermitPic> pic_addr_tuppp_list) {
		this.pic_addr_tuppp_list = pic_addr_tuppp_list;
	}
