...
public class SysMenuBtnService<T> extends BaseService<T> {
	 ...
	 * @date 2016年11月23日
	 * @description 根据条件获取按钮ID
	 * @return
	 */
	public Integer getBtnIdByMenuNameAndBtnName(String menuName,String btnName){
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("name", menuName);
		params.put("btnName", btnName);
		List<SysMenuBtn> list = getMapper().queryBtnJoinMenu(params);
