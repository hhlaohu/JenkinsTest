...
public class TabAffiliateRuleReportListModel extends BaseModel {
    ...
    public TabAffiliateRuleReportListModel(){
   
    }
    
    public TabAffiliateRuleReportListModel(Long report_id){
