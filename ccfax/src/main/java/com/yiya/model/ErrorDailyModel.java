...
public class ErrorDailyModel extends BaseModel {
	...
	private int error_deal_with;//处理人
	...
	public int getError_deal_with() {
		return error_deal_with;
	}
	public void setError_deal_with(int errorDealWith) {
