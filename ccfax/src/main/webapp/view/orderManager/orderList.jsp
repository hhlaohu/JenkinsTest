	...
	<!-- Search panel start -->
 	 ...
 	 <form id="searchForm">
 	 	...
 	 	<p class="ui-fields">
 	 	    ...
 	 	    <input name="borrower_mobile_phone" class="easyui-box ui-text" style="width:120px;">
        </p>
 	 	<p class="ui-fields">
...
<script type="text/javascript" src="${msUrl}/js/ux/orderManager/orderList.js?timestamp="<%=new Date().getTime() %>></script>
  </body>
</html>
